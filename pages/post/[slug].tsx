    ...
    <main>
        ...
        <article className='max-w-3xl mx-auto p-5 '>
            ...
            <div className='flex items-center space-x-2 '>
                <img
                    className='h-10 w-10 rounded-fulls' 
        ...
        <hr className='maw-w-lg my-5 mx-auto border-yellow-500'/>
        ...
        <form className='flex flex-col p-5 max-w-2xl mx-auto mb-10 '> 
            ...
            <label className='block mb-5'>
                ...
                <input className='shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring' type="text" placeholder='johnAppleseed@appleseed.com' />
            </label>
            <label className='block mb-5'>
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    const query = `*[_type == "post" && slug.current == $slug][0]{
      ...
      return {
          ...
          revalidate: 60, // refreshes cache after 60 secs
      }
}
